  ...
  return (
    <div>
      ...
      <form onSubmit={assign}>
        <select
          value={selectedPoke}
          onChange={(ev) => setSelectedPoke(ev.target.value)}
        >
        ...
        <select
          ...
          onChange={(ev) => setSelectedTrainer(ev.target.value)}
        >
        ...
        <div>
          <button disabled={!selectedPoke || !selectedTrainer} type="submit">Assign!</button>
        </div>
      </form>
    </div>
  );
